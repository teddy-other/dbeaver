 ...
 */
package org.jkiss.dbeaver.ext.coradb.model.plan;
...
public class CoraDbQueryPlanner extends CubridQueryPlanner
{

    private CoraDbDataSource dataSource;

    public CoraDbQueryPlanner(CoraDbDataSource dataSource) {
        super(null);
