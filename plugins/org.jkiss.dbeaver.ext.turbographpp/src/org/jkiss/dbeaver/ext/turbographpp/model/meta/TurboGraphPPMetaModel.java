...
import org.jkiss.dbeaver.ext.turbographpp.model.TurboGraphPPVertex;
import org.jkiss.dbeaver.ext.turbographpp.model.TurboGraphPPVertexColumn;
import org.jkiss.dbeaver.ext.turbographpp.model.TurboGraphPPEdge;
...
public class TurboGraphPPMetaModel extends GenericMetaModel {
    ...
    public GenericTableBase createTableOrViewImpl(GenericStructContainer container, String tableName, String tableType,
    	 ...
    	 if (tableType != null && isEdge(tableType)) {
             return new TurboGraphPPEdge(container, tableName, tableType, dbResult);
         } 
         
         return new TurboGraphPPVertex(container, tableName, tableType, dbResult);
    }
    ...
    public GenericTableColumn createTableColumnImpl(
            ...
            throws DBException {
        return new TurboGraphPPVertexColumn(table, columnName, typeName, columnSize, precision, scale);
    }
