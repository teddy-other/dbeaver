...
import org.jkiss.dbeaver.ext.turbographpp.model.QueryTransformerLimitCoraDB;
...
public class CoraDbMetaModel extends GenericMetaModel implements DBCQueryTransformProvider {
    ...
    public GenericTableBase createTableOrViewImpl(GenericStructContainer container, String tableName, String tableType,
    	 ...
    	 if (tableType != null && isEdge(tableType)) {
             return new CoraDbEdge(container, tableName, tableType, dbResult);
         } 
         
         return new CoraDbVertex(container, tableName, tableType, dbResult);
    }
    ...
    public GenericTableColumn createTableColumnImpl(
            ...
            throws DBException {
        return new CoraDbVertexColumn(table, columnName, typeName, columnSize, precision, scale);
    }
