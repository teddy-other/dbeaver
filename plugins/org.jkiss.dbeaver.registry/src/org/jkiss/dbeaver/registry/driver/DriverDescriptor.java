...
public class DriverDescriptor extends AbstractDescriptor implements DBPDriver {
    ...
    /**
     * Returns (creating if needed) a driver loader restricted to a single library.
     * Used to let a specific connection pick one of the driver's attached libraries
     * without affecting other connections that use the same driver.
     *
     * @see DBPDriver#PROP_ACTIVE_DRIVER_LIBRARY_ID
     */
    @NotNull
